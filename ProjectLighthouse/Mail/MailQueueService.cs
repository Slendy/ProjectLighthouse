...
public class MailQueueService : IMailService, IDisposable
{
    ...
    public MailQueueService(ServerConfiguration serverConfiguration, IMailSender mailSender)
    {
        if (!serverConfiguration.Mail.MailEnabled) return;

        this.serverConfiguration = serverConfiguration;
        this.mailSender = mailSender;

        this.fromAddress = new MailAddress(serverConfiguration.Mail.FromAddress, serverConfiguration.Mail.FromName);
