...
public class ClientConfigurationController : ControllerBase
{
    ...
    public ClientConfigurationController(DatabaseContext database, ServerConfiguration serverConfiguration)
    {
    ...
    {
        string hostname = this.serverConfiguration.GameApiExternalUrl;
        return this.Ok
        (
            ...
            $"ShowLevelBoos {this.serverConfiguration.UserGeneratedContentLimits.BooingEnabled.ToString().ToLower()}\n"
        );
    }
